...
const sendEmail = (e) => {
    e.preventDefault()
    //EMAIL JS 
    // serviceID : 'service_npla1op'
    //templateID : 'template_hd1mb0c'
    //#form : '#contact-form' 
    //publicKey: 'VR2VkledmLDTEU_6a'
    emailjs.sendForm('service_npla1op', 'template_hd1mb0c', '#contact-form', 'VR2VkledmLDTEU_6a')
        .then(() => {
...
const sr = ScrollReveal({
    ...
    distance: '60px',
    duration: 2000,
    reset: true //animation repeat when come back
})
