...
export default class extends Controller {
    ...
    open(event) {
        ...
        const techStackHtml = typeof data.techStackHtml === 'string' ? data.techStackHtml.trim() : '';
        this.techTarget.innerHTML = techStackHtml;
        this.techTarget.hidden = techStackHtml.length === 0;
